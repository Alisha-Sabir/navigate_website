...
export default function Footer() {
  ...
  return (
    <footer
      className="text-center text-md-start text-muted position-relative"
    ...
    >
        ...
        <Col xs={12} md={8} lg={8} xl={6}>
          <div className="me-0 me-md-5 my-4">
            <h2 className="fw-bold">
              Your prospecting engine that never sleeps.
            </h2>
            <p className="pt-2" style={{ color: "#D0D4E0" }}>
              Contact us today to learn more about how Navigate can help you
        ...
        <Container className="text-center text-md-start mt-3 text-light border-bottom border-secondary">
          ...
          <Row className="mt-3">
            ...
            <Col
              ...
              lg={3}
              xl={2}
              className="mx-auto mx-md-0 mx-lg-2 mx-xl-auto mb-4"
            >
            ...
            <Col md={3} lg={3} xl={2} className="mx-auto mb-4">
              ...
              <p
                ...
                onClick={() =>
                  window.open(
                    `${footerLinksData.TermsConditions}#page=7`,
                    "_blank"
                  )
                }
              >
      ...
      >
        <Row>
          <Col xs={12} md={3} lg={3}>
            <Link legacyBehavior href={footerLinksData.facebook} passHref>
              <a
                target="_blank"
            ...
            <Link legacyBehavior href={footerLinksData.twitter} passHref>
              <a
                target="_blank"
                rel="noopener noreferrer"
            ...
            <Link legacyBehavior href={footerLinksData.insta} passHref>
              <a
                target="_blank"
                rel="noopener noreferrer"
            ...
            <Link legacyBehavior href={footerLinksData.linkedin} passHref>
              <a
                target="_blank"
                rel="noopener noreferrer"
